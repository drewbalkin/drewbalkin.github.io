...
We haven't yet used the CRRA utility property. What we will show is that for  is for all CRRA investors, we have that $\chi_0(\gamma) = \chi_0(0)$. That is the indifference price is the same for investors. Moreover, this indifference price is given by:
