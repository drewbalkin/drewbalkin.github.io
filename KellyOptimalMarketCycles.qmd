...
In terms of total return, the first component is from directly receiving the random stochastic payments given by the process $(D_t)$, and the remaining return is the price price return.
