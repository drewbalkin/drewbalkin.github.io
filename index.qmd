...
I offer a very simple model to offer the start of a framework for this question. I hope to develop this into a more robust model in the future. This work is included in my blog post on [Valuation-based Kelly Optimal Portfolios for Market Cycle Investing](./KellyOptimalMarketCycles.qmd).
